...
const ItemsSection = () => {
  return (
    <div className='relative'>
        <div className='relative pt-52 before:contents-[""] before:absolute before:left-0 before:top-0 before:bg-design-purple before:bg-gradient-purple-75 before:w-full before:bottom-32 before:z-[1]'>
            <div className='container px-4 mx-auto relative z-10 -mb-32 -mt-20 space-y-20 md:space-y-0 md:space-x-6 flex flex-col md:flex-row justify-between'>
                <div className='relative bg-gradient-gray-2 bg-neutral-250 p-6 flex items-center justify-center text-white'>
        ...
        <img src={rectangleBg} alt='Section bg' className='w-full' />
    </div>
  )
}
